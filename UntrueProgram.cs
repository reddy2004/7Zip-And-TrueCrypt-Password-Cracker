...
namespace _7Zip_And_TrueCrypt_Password_Cracker
{
    ...
    class UntrueProgram
    {
        ...
        public static Boolean CheckPasswordOnHeader(byte[] sector, String password) 
        {
            ...
            passphraseCheckResult = DecryptVolumeHeader(sector, password, null, hashAlgorithmsEnabled, encryptionAlgorithmsEnabled);
        ...
        public static Boolean CheckPassword(String inputFileName, String pw)
        {
            ...
            password = pw;
            volumeHeaderFilename = inputFileName;
            ...
            if (checkingPassword)
            {
                ...
                if (volumeHeaderHex == null && volumeHeaderLocation == -1)
                {
                    ...
                    Console.WriteLine(volumeHeaderSector.Length);
                ...
                passphraseCheckResult = DecryptVolumeHeader(volumeHeaderBytes, password, null, hashAlgorithmsEnabled, encryptionAlgorithmsEnabled);
        ...
        public static void UntrueMain(string[] args)
        {
            bool showHelp = false;
